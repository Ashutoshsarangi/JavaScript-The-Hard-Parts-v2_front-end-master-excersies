...
console.log('intersection --> ', intersection([[5, 10, 15, 20], [15, 88, 1, 5, 7], [1, 10, 15, 5, 20]]));
// should log: [5, 15]
...
console.log('objOfMatches---> ', objOfMatches(['hi', 'howdy', 'bye', 'later', 'hello'], ['HI', 'Howdy', 'BYE', 'LATER', 'hello'], function(str) { return str.toUpperCase(); }));
...
console.log('multiMap ---> ', multiMap(['catfood', 'glue', 'beer'], [function(str) { return str.toUpperCase(); }, function(str) { return str[0].toUpperCase() + str.slice(1).toLowerCase(); }, function(str) { return str + str; }]));
...
console.log('objectFilter ---> ', objectFilter(cities, city => city.toUpperCase())) // Should log { London: 'LONDON', Paris: 'PARIS'}
...
console.log('prioritize ---> ', prioritize(['curb', 'rickandmorty', 'seinfeld', 'sunny', 'friends'], startsWithS)); 
...
function highestFunc(objOfFuncs, subject) {
	return Object.keys(objOfFuncs).reduce((acc, curr) => {
...
// /*** Uncomment these to check your work! ***/
console.log('combineOperations ----> ', combineOperations(0, [add100, divByFive, multiplyByThree])); // Should output 60 -->
console.log('combineOperations ----> ', combineOperations(0, [divByFive, multiplyFive, addTen])); // Should output 10
